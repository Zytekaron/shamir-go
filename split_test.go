...
// TestIntegrity is designed to test for rare discrepancies
// caused by random byte values, galois field errors, etc.
//
// If this test passes, everything is working well.
// If it fails, something somewhere is subtly wrong.
